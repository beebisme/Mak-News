      ...
      <div className="flex justify-between py-6 px-10 bg-sky-900 drop-shadow-lg">
        ...
        <div className="flex justify-center">
          <div className="mb-3 xl:w-96">
            <form className="input-group relative hidden md:flex flex-row w-full">
              <input
                type="search"
            ...
            <button
              className="btn flex md:hidden px-6 py-2.5 bg-blue-600 rounded-lg text-white font-medium text-xs leading-tight uppercase shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center"
              type="button"
              id="button-addon2"
              onClick={() => {
                navigate("/search");
